...
export const useBoothsStore = defineStore('booths', () => {
  ...
  const _transformDataForBoothSale = (booth: BoothSale) => {
    ...
    return {
      ...
      start_time: formatHelpers.convert24to12Hour(booth.start_time),
      end_time: formatHelpers.convert24to12Hour(booth.end_time),
  ...
  const _transformDataForSave = (booth: BoothSale) => {
    ...
    booth.start_time = formatHelpers.convert12to24Hour(booth.start_time);
    booth.end_time = formatHelpers.convert12to24Hour(booth.end_time);
