...
// Mock the AuditPartialMatchesDataTable component
vi.mock('@/components/audit/AuditPartialMatchesDataTable.vue', () => ({
  default: {
    name: 'AuditPartialMatchesDataTable',
    template: '<div class="audit-partial-matches-datatable-mock"></div>',
  },
}));
