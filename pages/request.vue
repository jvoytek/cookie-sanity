      ...
      >
        <a class="flex items-center" href="#">
          ...
          <span
            ...
            >Cookie Sanity Cookie Request Form</span
          >
        </a>
      </div>
    </div>
  </div>
  <div class="bg-surface-100 dark:bg-surface-800 min-h-screen">
    <div class="py-6 px-6 mx-0 md:mx-12 lg:mx-20 lg:px-20">
      <div class="card">
        <div class="text-center mb-8 col-span-2">
          <div
            class="text-surface-900 dark:text-surface-0 text-3xl font-medium mb-4"
          >
            Request cookies for {{ sellerInfo?.first_name }}
          </div>
        ...
        <div v-if="requestSubmitted" class="text-center col-span-2">
        ...
        <div v-else-if="!loading && sellerInfo" class="flex flex-col gap-6">
          <FormKit
            id="request-form"
