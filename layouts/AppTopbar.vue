...
<template>
    <div class="layout-topbar">
        <div class="layout-topbar-logo-container">
            <button v-if="user" class="layout-menu-button layout-topbar-action" @click="toggleMenu">
                <i class="pi pi-bars"></i>
            </button>
            <router-link to="/" class="layout-topbar-logo">
                <svg viewBox="0 0 122.88 122.25" width="54" height="40" fill="none" version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg">
                    <g>
                        <path
